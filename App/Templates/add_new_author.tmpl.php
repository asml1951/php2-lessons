...
<body>
<div class="container">
    <h2>Добавьте нового автора</h2>

    <form action="add_new_author.php" >

        <div class="form-group">
            <label for="exampleFormControlInput1">Имя</label>
            <input type="text" name="first_name" class="form-control" id="Input1" placeholder="Введите имя">
        </div>


        <div class="form-group">
            <label for="exampleFormControlTextarea1">Фамилия</label>
            <input type="text" class="form-control" name="last_name" id="Input2"  placeholder="Введите фамилию"></input>
        </div>

        <button type="submit" class="btn btn-primary mb-2">Добавить автора</button>
